...
class InstagramSpider(scrapy.Spider):
    ...
    def __init__(self, find_user, hash_number):
        super().__init__()
        if hash_number == 0:
            self.hash_number = hash_number
            self.find_hash = '5aefa9893005572d237da5068082d8d5'
        else:
            self.hash_number = hash_number
            self.find_hash = '3dec7e2c57367ef3da3d987d89f9dbc8'
        self.user_to_parse = find_user
    ...
    def get_user_subscribers(self, response: HtmlResponse, username, date_load):
        ...
        url = f"{self.graphql_url}query_hash={self.find_hash}&variables={str_variables}"
